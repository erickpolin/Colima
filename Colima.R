...
attach(ConcColima) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcColima<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcColima) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcColima$factor,to.data.frame=TRUE)
...
ConcColima$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcColima$MAXT<-ConcColima$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcColima<-ConcColima[with(ConcColima, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcColima$ACUMULA<-cumsum(ConcColima$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcColima[dim(ConcColima[ConcColima$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcColima<-rbind(ConcColima[1:(dim(ConcColima[ConcColima$ACUMULA<tam_dec*i,])[1]+1),],
                             ConcColima[(dim(ConcColima[ConcColima$ACUMULA<tam_dec*i,])[1]+1):dim(ConcColima[1])[1],])
  
  b1<-tam_dec*i-ConcColima[dim(ConcColima[ConcColima$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcColima[(dim(ConcColima[ConcColima$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcColima[(dim(ConcColima[ConcColima$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcColima$ACUMULA2<-cumsum(ConcColima$factor)
...
ConcColima[(ConcColima$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcColima[((ConcColima$ACUMULA2>tam_dec*i)&(ConcColima$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcColima[ConcColima$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Colima")
write.dbf(ConcColima,file="ConcColima2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Colima")
write.dbf(ConcColima,file="ConcColima2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Colima")
Conc2010<-read.dbf("ConcColima2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Colima por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Colima por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Colima por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Colima por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Colima por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Colima INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Colima INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Colima INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Colima INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Colima INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Colima NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Colima NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Colima NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Colima NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Colima NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Colima")
Conc2018<-read.dbf("ConcColima2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Colima Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Colima Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Colima Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Colima Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Colima Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Colima INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Colima INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Colima INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Colima INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Colima INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Colima NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Colima NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Colima NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Colima NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Colima NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("Colima por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("Colima Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("Colima NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("Colima NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("Colima INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("Colima INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
